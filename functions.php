...
function otm_paging_nav(){
	...
	?>
	<nav class="navigation paging-navigation content">
		<div class="nav-links">

			<?php if ( get_next_posts_link() ) : ?>
			<div class="nav-previous"><?php next_posts_link( __( '< Older posts', 'otm-skeleton' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( __( 'Newer posts >', 'otm-skeleton' ) ); ?></div>
			<?php endif; ?>
...
function otm_post_nav(){
	...
	?>
	<nav class="navigation post-navigation content">
		<div class="nav-links">
			<?php
				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<&nbsp;%title', 'Previous post link', 'otm-skeleton' ) );
				next_post_link(     '<div class="nav-next">%link</div>',     _x( '%title&nbsp;>', 'Next post link',     'otm-skeleton' ) );
			?>
		</div>
	</nav>
	<?php
